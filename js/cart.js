...
products[0] = new Product("001", "Crayons",  0.99);
products[1] = new Product("002", "Jumprope",    9.95);
products[2] = new Product("003-a", "Lunch Box (Red)",  9.95);
products[3] = new Product("003-b", "Lunch Box (Yellow)",  9.95);
products[4] = new Product("003-c", "Lunch Box (Blue)",  9.95);
products[5] = new Product("004-a", "Junie B. Jones (Junie B. Jones has a Peep in her Pocket)",  14.95);
products[6] = new Product("004-b", "Junie B. Jones (Junie B. Jones and the Mushy Gushy Valentine)",  14.95);
products[7] = new Product("004-c", "Junie B. Jones (Junie B.'s Essential Survival Guide to School)",  14.95);
products[8] = new Product("005-a", "Sillybands (Jungle)",  4.95);
products[9] = new Product("005-b", "Sillybands (Beach)",  4.95);
products[10] = new Product("005-c", "Sillybands (Fruit)",  4.95);
products[11] = new Product("006", "Gum",  .99);
products[12] = new Product("007", "Lanyards",  9.95);
products[13] = new Product("008-a", "Selfie Stick (Pink)",  9.95);
products[14] = new Product("008-b", "Selfie Stick (Ywllow)",  9.95);
products[15] = new Product("008-c", "Selfie Stick (Blue)",  9.95);
products[16] = new Product("009", "Mechanical Pencils",  14.95);
products[17] = new Product("010", "Axe Body Spray",  9.95);
products[18] = new Product("011", "Stress Ball",  1.99);
products[19] = new Product("012", "Custom Coffee Mug",  9.95);
products[20] = new Product("013", "Earbuds",  19.95);
products[21] = new Product("014", "Planner",  14.95);
products[21] = new Product("015", "Netflix Subscription",  20.95);
...
var shipping_rate = 2.99; // (will not be applied if free_shipping = true)
